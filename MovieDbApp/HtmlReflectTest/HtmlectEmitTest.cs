...
namespace HtmlReflectTest
{
    ...
    public class HtmlectEmitTest
    {
        ...
        static HtmlectEmit htmlectEmiter = new HtmlectEmit();

        [TestMethod]
        public void ToHtmlEmitTest()
        {
            Assert.AreEqual(htmlectEmiter.ToHtml(movie), expectedMovie);
        }

        [TestMethod]
        public void ToHtmlEmitArrayTest()
        {
            Assert.AreEqual(htmlectEmiter.ToHtml(movies), expectedMovies);
        }
    }
}
