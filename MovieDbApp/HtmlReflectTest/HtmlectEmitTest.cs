...
namespace HtmlReflectTest
{
    ...
    public class HtmlectEmitTest
    {
        ...
        {
            Movie movie = new TheMovieDbClient().MovieDetails(11);
            HtmlectWithEmitter htmlectEmiter = new HtmlectWithEmitter();
            String result = htmlectEmiter.ToHtml(movie);
        ...
        {
            MovieSearchItem[] movies = new TheMovieDbClient().Search("Star Wars", 1);
            HtmlectWithEmitter htmlectEmiter = new HtmlectWithEmitter();
            String result = htmlectEmiter.ToHtml(movies);
